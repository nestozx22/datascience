...
ggplot(df_order10, aes(x,TypeofBreach)) + geom_col(alpha=0.8, color = "gray")+ labs(title = "Personas afectadas por tipo de brecha ")+xlab("Millones de Personas afectadas")+  ylab("Tipo de brecha")+ theme(legend.position = 'none',axis.text.x = element_text(angle = 30, vjust=0.6, size = 6))
